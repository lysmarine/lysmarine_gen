module.exports = {
  commands1 : [
    ...
    {name: 'winds', title: 'Winds', img: 'race', bg: 'RoyalBlue', cmd: 'gtk-launch', args: ['windy']},
    {name: 't-storms', title: 'T-Storms', img: 'weather', bg: 'SeaGreen', cmd: 'gtk-launch', args: ['lightningmaps']},
