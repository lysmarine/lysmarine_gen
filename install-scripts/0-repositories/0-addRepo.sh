...
install -m0644 -v $FILE_FOLDER/bbn-gtk2-repo.list "/etc/apt/sources.list.d/"
...
wget -q -O- https://dl.cloudsmith.io/public/bbn-projects/bbn-gtk2-repo/cfg/gpg/gpg.937F9585EB75CD5A.key | apt-key add -
